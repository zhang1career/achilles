...
import lab.zhang.honaos.achilles.token.operand.instant.InstantOperand;
...
import static lab.zhang.honaos.achilles.optimizer.impl.CacheCalculatingOptimizer.OPTIMIZE_INFO_RESULT;
...
public class DelegatedWorkerPoolImplTest {
    ...
    public void test_single_operator_additionOfInteger() throws Exception {
        ...
        Object resultObj = ((Map<String, Object>) calculatingCacheOptimizer.getOptimizeInfo()).get(OPTIMIZE_INFO_RESULT);
        Map<Integer, InstantOperand<?>> resultMap = (Map<Integer, InstantOperand<?>>) resultObj;
        if (resultMap == null) {
            System.out.println("The optimizing resultMap is null");
            return;
        }
        InstantOperand<?> resultOperand = resultMap.get(0);
        if (resultOperand == null) {
            System.out.println("The optimizing resultOperand is null");
            return;
        }
        System.out.println(resultOperand.eval(context));
    }
    ...
    public void test_single_operator_httpClient() throws Exception {
        ...
        Object infoObj = ((Map<String, Object>) calculatingCacheOptimizer.getOptimizeInfo()).get(OPTIMIZE_INFO_RESULT);
        System.out.println(((Map<Integer, InstantOperand<?>>) infoObj).get(0).eval(context));
    }
